...
Crawl is about making the project legible, not about running workflows. If you find yourself wanting `/start-pr`, `/review-pr`, or `/compound`, you're ready to graduate to [`ai-native-dev-scaffold`](https://github.com/Epistemic-Me/ai-native-dev-scaffold) (Walk) or [`ai-native-dev-scaffold-compound`](https://github.com/Epistemic-Me/ai-native-dev-scaffold-compound) (Run).
